...
| `company-bankid-init` | ═══════════════════════════════════════════════════════════════ SPICK – company-bankid-init (Fas 7.5 §B2B.1 — TIC BankID |
| `company-bankid-verify` | ═══════════════════════════════════════════════════════════════ SPICK – company-bankid-verify (Fas 7.5 §B2B.2 — TIC Comp |
